...
def build(output: Path) -> None:
    ...
    worker = '\n'.join((ROOT / 'src' / name).read_text() for name in ('math.js','geometry.js','model.js','exchange.js','production.js','kernel.js', 'constraints.js','spatial-constraints.js','dynamic-blocks.js','fonts.js','unicode-bidi.js','mtext.js','source-document.js','productivity.js','fields.js'))
