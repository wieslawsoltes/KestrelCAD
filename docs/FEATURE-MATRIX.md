...
| Text | Local SHX/SHP and browser outline fonts; native rich MTEXT with scopes, fractions, paragraphs, Unicode bidi runs, masks and native columns; native associative fields, safe formulas and drawing properties | Proprietary/Date/Sheet Set fields, linked-column DXF, vertical MTEXT, Big Fonts and complete font/layout equivalence |
