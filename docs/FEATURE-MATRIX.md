...
| Configurable blocks | Native typed parameters, expressions, lookup, visibility, flip, move/stretch/rotate/scale and rectangular/polar arrays; inverse discrete-table matching | Autodesk proprietary action-graph evaluation and native DWG dynamic-block compatibility |
