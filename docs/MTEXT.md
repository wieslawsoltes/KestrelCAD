...
Implemented formatting controls: nested brace scopes; escaped braces and backslashes; Unicode escapes; paragraph/column breaks; nonbreaking spaces; indexed and RGB colors; height/width/tracking/slant; inline font, bold and italic; underline, overline and strike-through; three fraction-stack separators; inline baseline alignment; paragraph indents, tab stops, spacing, left/center/right/justified/distributed alignment. Unknown controls and fields remain in the saved raw source. Unsupported controls are reported, and fields are displayed literally, never executed.
